...
char *GoVersion(void);
int GoAutoUpdateEnabled(void);
void GoSetAutoUpdate(int on);
char *GoReleasesPage(void);
char *GoCheckUpdate(void);
char *GoDownloadUpdate(void);
void GoCancelUpdateDownload(void);
